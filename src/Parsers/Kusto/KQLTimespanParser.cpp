...
std::optional<Int64> KQLTimespanParser::parse(const std::string & expression)
{
...
bool KQLTimespanParser::tryParse(const std::string & expression, std::optional<Int64> & ticks)
{
    try
    {
